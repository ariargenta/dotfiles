...
local function FloatingTerminal()
	...
	vim.api.nvim_set_hl(0, "FloatingTermnBorder", { bg = "none" })
...
vim.keymap.set("n", "<leader>t", FloatingTerminal, { noremap = true, silent = true, desc = "Toogle floating terminal" })
